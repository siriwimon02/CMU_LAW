...
async function main() {
    ...
    const status_db = ['รอรับเข้ากอง', 'รับเข้ากองเรียบร้อยแล้ว', 'กำลังตรวจสอบเอกสาร', 'แก้ไขเอกสาร','ตรวจสอบเอกสารเรียบร้อยแล้ว', 'รอการอนุมัติ', 'อนุมัติเรียบร้อย', 'ปฎิเสธคำร้อง'];
